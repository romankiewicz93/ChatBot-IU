...
class ConversationViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tableView.register(ConversationCell.self, forCellReuseIdentifier: "Answer")
        tableView.register(QuestionCell.self, forCellReuseIdentifier: "Question")
        tableView.register(ThinkingCell.self, forCellReuseIdentifier: "Thinking")
        tableView.register(AskCell.self, forCellReuseIdentifier: "Ask")
...
extension ConversationViewController {
    ...
    fileprivate enum ConversationSection: Int {
        ...
        static var askPath: IndexPath {
            return IndexPath(row: 0, section: ask.rawValue)
        }

        static var thinkingPath: IndexPath {
            return IndexPath(row: 0, section: thinking.rawValue)
        }
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        case .history:
            ...
            case .question: identifier = "Question"
                let cell: QuestionCell = tableView.dequeueReusableCell(withIdentifier: identifier, for: indexPath) as! QuestionCell
